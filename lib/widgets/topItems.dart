...
class TopItems extends StatelessWidget {
  const TopItems({super.key, required this.data, required this.tv});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Center(
        child: Column(
          children: [
            Text("***REMOVED***'s Top ${tv ? "Shows" : "Movies"}", style: GoogleFonts.passionOne(color: const Color.fromARGB(255, 232, 230, 227), fontSize: 30, fontWeight: FontWeight.w400),),
            Padding(
